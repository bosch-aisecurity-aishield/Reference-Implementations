# Object Detection Model with AIShield Integration
...
This repository contains reference implementations of a YOLO model for object detection, focusing on Pascal VOC Dataset. The implementations cover analysis types such as evasion. Additionally, the repository integrates the AIShield package for model vulnerability analysis and defense generation.
...
- **Evasion:** This implementation demonstrates evasion attacks on the Pascal VOC Dataset.
  - [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bosch-aisecurity-aishield/Reference-Implementations/blob/main/Product_Taskpair_wise/Object_Detection/Object_Detection_Evasion.ipynb)

## Dataset

The implementation utilizes the Pascal dataset.
...
This repository provides reference implementations of the Object Detection Task with Pascal VOC Dataset with AIShield integration, along with HTML versions of the notebooks for quick access and overview.
