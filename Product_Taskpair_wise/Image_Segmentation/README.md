# Pedestrian Image Segmentation Model with AIShield Integration
...
This repository provides reference implementations of the Pedestrian model with AIShield integration, along with HTML versions of the notebooks for quick access and overview.
