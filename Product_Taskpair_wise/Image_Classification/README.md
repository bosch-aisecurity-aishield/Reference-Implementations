...
This repository contains reference implementations of an MNIST model for image classification, specifically focusing on handwritten digit data. The implementations cover various analysis types, including extraction, evasion, and poisoning. The repository also integrates the AIShield package for model vulnerability analysis and defense generation.
...
- **Extraction:** This implementation demonstrates extraction attacks on the MNIST model.
...
- **Evasion:** This implementation demonstrates evasion attacks on the MNIST model.
  - [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bosch-aisecurity-aishield/Reference-Implementations/blob/main/Product_Taskpair_wise/Image_Classification/Image_Classification_Evasion.ipynb)

- **Poisoning:** This implementation demonstrates Poisoning attacks on the MNIST model.
  - [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bosch-aisecurity-aishield/Reference-Implementations/blob/main/Product_Taskpair_wise/Image_Classification/Image_Classification_Poisoning.ipynb)
